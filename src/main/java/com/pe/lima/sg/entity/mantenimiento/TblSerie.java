...
public class TblSerie implements java.io.Serializable {
	...
	public TblSerie(int codigoSerie, String tipoComprobante, String prefijoSerie, Integer secuencialSerie, Integer numeroComprobante,
	...
	@Column(name = "prefijo_serie", length = 1)
