...
public final class GastoSpecifications {
	...
	public static Specification<TblGasto> conEdificio(Integer intCodigoEdificio) {
	...
	public static Specification<TblGasto> conCodigoInterno(String codigoInterno) {
		return (root, query, cb) -> {
	...
	public static Specification<TblGasto> conEstado(String strEstado) {
		return (root, query, cb) -> {
	...
	public static Specification<TblGasto> conFechaGasto(Date datFecha) {
		return (root, query, cb) -> {
			if (datFecha != null){
				return cb.greaterThanOrEqualTo(root.<Date> get("fechaGasto"), datFecha);
			}else{
				return cb.equal(cb.literal(1), 1);
			}
