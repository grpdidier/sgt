...
public class NumberToLetterConverter {
     ...
     */
    public static String convertNumberToLetter(String number, String strMoneda)
            throws NumberFormatException {
        return convertNumberToLetter(Double.parseDouble(number), strMoneda);
    }
     ...
     */
    public static String convertNumberToLetter(double doubleNumber, String strMoneda)
            throws NumberFormatException {
